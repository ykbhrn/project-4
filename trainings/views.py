...
# Make Booking/ if bookings are = training limit capacity, then show training isFull/ and add student user who made
#  a booking to the student list in the training model
